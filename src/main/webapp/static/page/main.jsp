...
<div class="layui-row layui-col-space10 panel_box">
	...
	<div class="panel layui-col-xs12 layui-col-sm6 layui-col-md4 layui-col-lg2">
		<a href="javascript:;" data-url="https://github.com/FLxmw/WebOpenPlatform" target="_blank">
	...
	<div class="panel layui-col-xs12 layui-col-sm6 layui-col-md4 layui-col-lg2">
		<a href="javascript:;" data-url="https://gitee.com/flztdfef/web-open/tree/Web/" target="_blank">
	...
	<div class="panel layui-col-xs12 layui-col-sm6 layui-col-md4 layui-col-lg2">
		<a href="javascript:;" data-url="${pageContext.request.contextPath}/static/page/man/userList.jsp">
	...
	<div class="panel layui-col-xs12 layui-col-sm6 layui-col-md4 layui-col-lg2">
		<a href="javascript:;" data-url="${pageContext.request.contextPath}/static/page/systemSetting/icons.html">
...
<blockquote class="layui-elem-quote main_btn">
	<p>本项目模板基于Layui2.*实现，支持除LayIM外所有的Layui组件。<a href="http://layim.layui.com/#getAuth" target="_blank" class="layui-btn layui-btn-xs">获取LayIM授权</a>　layui开发文档地址：<a class="layui-btn layui-btn-xs layui-btn-danger" target="_blank" href="http://www.layui.com/doc">layui文档</a>　千人技术交流QQ群：<a target="_blank" href="//shang.qq.com/wpa/qunwpa?idkey=8b7dd3ea73528c1e46c5d4e522426d60deed355caefdf481c1eacdd1b7b73bfd"><img border="0" src="//pub.idqqimg.com/wpa/images/group.png" alt="layui后台管理模版" title="layui后台管理模版"></a>   站长QQ：<a class="layui-btn layui-btn-xs layui-btn-warm" target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=2285538755&site=qq&menu=yes">2285538755</a>（添加时请注明来源，如：“码云”、“github”等）</p>
	<p class="layui-red">郑重提示：本项目模版作为学习交流免费使用【强烈要求付费或者捐赠的我也就默默的接受了😄】，如需用作商业用途，请联系作者购买【本模版已进行作品版权证明，不管以何种形式获取的源码，请勿进行出售或者上传到任何素材网站，否则将追究相应的责任】</p>
	<p>注：本模版未引入任何第三方组件，前端界面layui+js实现的各种功能，后端采用SSM三层架构开发。网站所有数据均为动态数据，有远程的云数据库连接，可以进行增删改查的一系列操作(不要过多的进行删改)，可供玩家们畅玩，除打开的窗口和部分小改动外所有操作刷新后无效，关闭窗口或清除缓存后，所有操作无效，请知悉。</p>
	<p class="layui-blue">PS：这只是项目开发模版而不是定制开发，不能覆盖升级很正常，请不要因为不能覆盖升级来喷我，我表示很无辜，谢谢大家</p>
<div class="layui-row layui-col-space10">
	...
	<script type="text/javascript">
		...
		function getLangDate(){
			...
			document.getElementById("nowTime").innerHTML = "亲爱的${param.username}，"+timeValue+"好！ 欢迎进入望望畅游平台。当前时间为： "+newDate+"　"+week;
		...
		layui.use(['form','element','layer','jquery'],function(){
			...
			function fillParameter(data){
				...
				$(".server").text(nullData(data.serverEn));        //服务器环境
				$(".dataBase").text(nullData(data.dbVersion));    //数据库版本
				$(".maxUpload").text(nullData(data.maxUpload));    //最大上传限制
				$(".userRights").text(nullData(data.userLimit));//当前用户权限
			}

			//最新文章列表
			$.get("${pageContext.request.contextPath}/news/showTable",function(data){
				var hotNewsHtml = '';
				for(var i=0;i<5;i++){
					hotNewsHtml += '<tr>'
			...
			//用户数量
			$.get("${pageContext.request.contextPath}/user/showTable",function(data){
